...
with st.form("soil_input"):
    ...
    with col1:
        N = st.number_input("Nitrogen (N) [mg/kg]", 6.0, 383.0, 100.0, help="Unit: kg/ha | Range: 6 - 383")
        P = st.number_input("Phosphorus (P) [mg/kg]", 2.9, 125.0, 50.0, help="Unit: kg/ha | Range: 2.9 - 125")
        K = st.number_input("Potassium (K) [mg/kg]", 11.0, 887.0, 150.0, help="Unit: kg/ha | Range: 11 - 887")
        pH = st.number_input("pH [Unitless]", 0.9, 11.15, 6.5, help="Unit: pH | Range: 0.9 - 11.15")
    with col2:
        ...
        S = st.number_input("Sulfur (S) [mg/kg]", 0.64, 31.0, 10.0, help="Unit: mg/kg | Range: 0.64 - 31")
        Zn = st.number_input("Zinc (Zn) [mg/kg]", 0.07, 42.0, 0.5, help="Unit: mg/kg | Range: 0.07 - 42")
    with col3:
        Fe = st.number_input("Iron (Fe) [mg/kg]", 0.21, 44.0, 4.0, help="Unit: mg/kg | Range: 0.21 - 44")
        Cu = st.number_input("Copper (Cu) [mg/kg]", 0.09, 3.02, 0.5, help="Unit: mg/kg | Range: 0.09 - 3.02")
        Mn = st.number_input("Manganese (Mn) [mg/kg]", 0.11, 31.0, 5.0, help="Unit: mg/kg | Range: 0.11 - 31")
        B = st.number_input("Boron (B) [mg/kg]", 0.06, 2.82, 0.5, help="Unit: mg/kg | Range: 0.06 - 2.82")
